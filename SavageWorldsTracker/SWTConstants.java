...
public interface SWTConstants
{
   ...
   public static final double NAME_WIDTH = 0.29;
   ...
   public static final double CARD_WIDTH = .16;
   public static final double HAS_ACTED_WIDTH = .07;
   public static final double SHAKEN_WIDTH = .07;
   ...
   public static final double SHAKEN_INSET = HAS_ACTED_INSET + HAS_ACTED_WIDTH;
